...
(async () => {
  ...
  await fs.writeFile("other-psychotic-disorders-and-severe-mental-illnesses-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("other-psychotic-disorders-and-severe-mental-illnesses-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
